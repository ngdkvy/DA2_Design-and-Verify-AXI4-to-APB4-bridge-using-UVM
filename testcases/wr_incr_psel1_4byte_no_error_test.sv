class wr_incr_psel1_4byte_no_error_test extends apb_base_test;
     `uvm_component_utils(wr_incr_psel1_4byte_no_error_test)

     apb_configuration apb_config;
     wr_incr_psel1_4byte_no_error_sequence wr_incr_psel1_4byte_no_error_seq;

     function new(string name = "wr_incr_psel1_4byte_no_error_test", uvm_component parent);
